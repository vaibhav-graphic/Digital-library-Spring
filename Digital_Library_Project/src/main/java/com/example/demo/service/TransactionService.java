...
public class TransactionService {
	...
	public String returnTxn(int bookId,int studentId) throws Exception {
		...
		Transaction issueTransaction = transactionRepository.findTopByMyStudentAndMyBookAndTransactionTypeAndTransactionStatusOrderByTransactionTimeDesc(student, book, TransactionType.ISSUE, TransactionStatus.SUCCESS);
